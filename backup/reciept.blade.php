...
<div id="invoice-POS" style="padding-left: 38px;padding-right: 0px;padding-bottom: 190px;position: relative;">
    ...
    <div id="bot">
        ...
        <div id="legalcopy">
            ...
            <p style="text-align:center;"> {{ substr($rec_data[91],-4) }} {{ $rec_data[92] }} {{ $rec_data[94] }}
                {{ substr_replace($rec_data[95], "", -3) }} </p>

            <p style="text-align:center;">{{ substr($rec_data[95],-3) }} {{ $rec_data[96] }} {{ $rec_data[97] }}
            ...
            <p style="text-align:center;"> {{ substr($rec_data[121],-4) }} {{ substr_replace($rec_data[137], "", -4) }}
                ...
                <p style="text-align:center;"> {{ substr($rec_data[143],-4) }} {{ $rec_data[152] }} {{ substr_replace($rec_data[153], "", -3) }}
                </p>
                ...
                <p style="text-align:center;"> {{ substr($rec_data[167],-3) }} {{ substr_replace($rec_data[178], "", -4) }}
                </p>
                ...
                <p style="text-align:center;"> {{ $rec_data[264]}}  {{ $rec_data[265] }}  &nbsp;{{ $rec_data[266] }} &nbsp;{{ $rec_data[267] }} 
                </p>

                <p style="text-align:center;">  {{ $rec_data[293] }}
                </p>
