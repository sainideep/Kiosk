                ...
                <table class="table " id="order_table">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase  text-xxs  ">Order Id</th>
                      <th class="text-uppercase  text-xxs font-weight-bolder ps-2">Customer Name</th>
                      <th class=" text-uppercase  text-xxs font-weight-bolder">Restaurant Name</th>
                      <th class=" text-uppercase  text-xxs font-weight-bolder">Staff Name</th>
                      <th class=" text-uppercase  text-xxs font-weight-bolder">Amount</th>
