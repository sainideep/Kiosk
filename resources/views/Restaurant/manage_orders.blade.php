...
@section('main_section')
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg " style="overflow-y: hidden;">
    <!-- Navbar -->
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder mb-0">Manage Orders({{$staff_name->name}})</h6>
        </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-1 " style="position: fixed;width: 75%;">
                <h6 class="text-white text-capitalize ps-3">Manage Orders({{$staff_name->name}})</h6>
                <h6 class="text-white text-capitalize ps-3" style="position: relative;top: 68px;"> </h6>
                <div class="col-5" style="text-align: right; margin-left: 59%; height: 59px">
                 <a href="{{url('Restaurant/manage_staff_order')}}" style="color: white !important;padding: 1px 68px 12px 7px;"><i class="material-icons opacity-10">arrow_back</i></a>
                </div>
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive" style="padding: 3px 20px;padding-top: 82px;height: 470px;overflow-y: scroll;">
