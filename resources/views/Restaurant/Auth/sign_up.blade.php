...
<body class="bg-gray-200">
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                  <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Restaurant Owner Panel</h4>                 
                </div>
              </div>
              <div class="card-body">
                <form role="form" class="text-start" action="sign_up" method="post">
                  @csrf
                <div class="input-group input-group-outline my-3">
                   
                    <input type="text" class="form-control @error('rest_name') is-invalid @enderror" placeholder="Restaurant Owner Name" name="rest_name" value="{{ old('rest_name')}}" >
                    @error('rest_name')
                  ...
                  <div class="input-group input-group-outline my-3">
                    <input type="tel" class="form-control @error('contact_number') is-invalid @enderror" value="{{ old('contact_number')}}" placeholder="Contact Number" name="contact_number">
                  ...
                  <p class="mt-4 text-sm text-center">
                    Have an account?
                    <a href="{{url('Restaurant/login')}}" class="btn bg-gradient-primary">Sign in</a>
                  </p>
                </form>
              </div>
            </div>
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-12 col-md-6 my-auto">
              <div class="copyright text-center text-sm text-white text-lg-start">
                ...
                <a href="#" class="font-weight-bold text-white" target="_blank">Protolabz E Services</a>
                for a better web.
              </div>
            </div>
           </div>
  ...
  <script type="text/javascript">
    @if(Session::has('message'))
       ...
       setInterval(function () { window.location.href = '{{url("Restaurant/login")}}' }, 2000);
    @endif
