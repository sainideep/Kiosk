          ...
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                ...
                @endif
                <form role="form" class="text-start" action="{{url('Restaurant/Restaurant_login')}}" method="post">
                  @csrf
                  ...
                  <p class="mt-4 text-sm text-center">
                    ...
                    <a href="{{url('Restaurant/sign_up')}}" class="btn bg-gradient-primary ">Sign up</a>
                  </p>
                </form>
              </div>
            </div>
