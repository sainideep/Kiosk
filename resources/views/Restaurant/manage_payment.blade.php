...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
   <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
              <h6 class="font-weight-bolder mb-0">Manage Payment</h6>
          </div>
        </nav>
      </div>
    </nav>
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-2">
                <div class="row">
                  <div class="col-6">
                    <h6 class="text-white text-capitalize ps-3">Manage Payment</h6>
                  </div>
                ...
                <table class="table align-items-center mb-0" id="staff_table" style="width: 100%">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder ps-2">Payment</th>
  ...
  <script> 
    var table = $('#staff_table').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('Restaurant/manage_payment') }}",
        columns: [
