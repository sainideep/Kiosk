...
@section('main_section')
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-1 " >
                ...
                left: 15px;color:white;font-weight:500;top: -8px;">
                ...
                <div class="col-5" style="text-align: right; margin-left: 59%; height: 59px">
                  <a href="{{url()->previous()}}" style="color: white;padding: 1px 68px 12px 7px;"><i class="material-icons opacity-10">arrow_back</i></a>
                </div>
              </div>
            </div>
                ...
                <table class="table align-items-center mb-0" id="table_id" style="width: 991px !important">
                  <thead>
                    <tr>
                      ...
                      <th class="text-secondary text-xxs font-weight-bolder " style="text-transform: inherit;">Price</th>
      ...
      <section>
        <table class="table align-items-center mb-0  bg-white"  style="width: 500px !important;height:200px !important; ">
        <thead>
          <tr>
...
$(document).ready(function () {
  $('body').removeAttr('style');
    $('#table_id').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('Staff/order_items',$orderId) }}",
        columns: [
