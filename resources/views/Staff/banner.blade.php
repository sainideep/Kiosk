    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <h6 class="font-weight-bolder mb-0">Manage Banner</h6>
        </nav>
        ...
        <div class="col-12">
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-1 {{ $banner == 'false' ? 'pb-5' : ''}}   ">
                <h6 class="text-white text-capitalize ps-3">Manage Banner</h6>               
                  <div class="col-5" style="text-align: right; margin-left: 59%;">
                  @if(!$banner)
                    <button type="button" class="btn mt-2" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" style="width: max-content;background: beige; color: black;font-size: 13px;"><b>Add Banner</b></button>
                  @endif
                  </div>                
              </div>
            </div>
            <div class="card-body px-0 pb-2">
              <div class="table-responsive " style="padding: 20px">
                <table class="table align-items-center mb-0" id="banner_table">
                  <thead>
                    <tr>
        ...
        <div class="modal-body">
          <form  method="post" enctype="multipart/form-data" id="add_banner">
            ...
            <div class="form-group" id="image_section" style="display: none">
              <label for="">Upload Image (1080 x 1481)</label>
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn bg-gradient-primary" id="submitForm">Add Banner</button>
            </div>
          </form>
        </div>
